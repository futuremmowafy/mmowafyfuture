...
async function fix() {
  ...
  console.log('Old Liquidity:', finData.liquidity);

  // Correct the balances
  finData.liquidity['حساب بنك مصر بيزنيس (الشركة)'] = 1000;
  finData.liquidity['محفظة بنك مصر'] = 24617;
  ...
  if (updateErr) {
    ...
    console.log('Successfully corrected balances!');
    console.log('New Liquidity:', finData.liquidity);
  }
}
