...
export function extractAcBrandAndSpecifier(text) {
  ...
  // Detect specifiers
  let specifier = '';
  if (lower.includes('بارد ساخن انفرتر') || lower.includes('بارد وساخن انفرتر') || lower.includes('بارد/ساخن انفرتر')) {
    specifier = 'بارد ساخن انفرتر';
  } else if (lower.includes('بارد ساخن') || lower.includes('بارد وساخن') || lower.includes('بارد/ساخن')) {
    if (lower.includes('انفرتر') || lower.includes('أنفرتر')) {
      specifier = 'بارد ساخن انفرتر';
    } else {
      specifier = 'بارد ساخن عادي';
    }
  } else if (lower.includes('بارد انفرتر') || (lower.includes('انفرتر') && !lower.includes('ساخن'))) {
    specifier = 'بارد انفرتر';
  } else if (lower.includes('بارد عادي') || (lower.includes('بارد') && !lower.includes('انفرتر') && !lower.includes('ساخن'))) {
    specifier = 'بارد عادي';
  } else if (lower.includes('كونسيلد')) {
    specifier = 'كونسيلد';
  } else if (lower.includes('فري ستاند') || lower.includes('عمودي')) {
    specifier = 'فري ستاند';
  } else if (lower.includes('شباك')) {
    specifier = 'شباك';
  }
