...
16. قاعدة تصنيف وتسمية موديلات التكييفات الصارمة (بارد / ساخن / انفرتر):
- في سوق ومجال التكييفات في مصر، لا يوجد في تكييفات السبليت شيء اسمه "ساخن فقط"، بل كل تكييف ساخن هو بالضرورة والبديهة تكييف (بارد ساخن):
  * إذا نطق المتحدث أو كتب: "ساخن" أو "ساخن عادي" أو "سخن" أو "سخن عادي" -> يجب تعيين brand دائماً كـ: "[الماركة] بارد ساخن عادي" (مثال: "ميديا ساخن عادي" أو "ميديا ساخن" أو "ميديا سخن" أو "ميديا 1.5 ساخن عادي" -> اضبط brand فوراً كـ: "ميديا بارد ساخن عادي").
  * إذا نطق المتحدث أو كتب: "ساخن انفرتر" أو "سخن انفرتر" -> يجب تعيين brand دائماً كـ: "[الماركة] بارد ساخن انفرتر" (مثال: "ميديا ساخن انفرتر" -> اضبط brand: "ميديا بارد ساخن انفرتر").
  * إذا نطق المتحدث: "بارد" أو "بارد عادي" أو "عادي" -> تُكتب: "[الماركة] بارد عادي" (مثال: "ميديا بارد عادي" -> brand: "ميديا بارد عادي").
  * إذا نطق المتحدث: "انفرتر" أو "بارد انفرتر" (بدون ذكر كلمة ساخن أو سخن) -> تُكتب: "[الماركة] بارد انفرتر".
- تحذير حاسم وقاطع: ممنوع منعاً باتاً استخراج كلمة "ساخن عادي" بمفردها كماركة، وممنوع نهائياً تحويل "ساخن" أو "سخن" إلى "بارد عادي"! أي عملية يُذكر فيها "ساخن" أو "سخن" يجب أن يحتوي حقل brand فيها على "بارد ساخن".
...
صيغة الـ JSON المطلوبة:
{
  ...
  "data": {
    ...
    "brand": "الماركة والموديل بالضبط (مثل: كاريير بارد عادي، كاريير بارد انفرتر، كاريير بارد ساخن عادي، كاريير بارد ساخن انفرتر، كاريير كونسيلد، ميديا بارد عادي، ميديا بارد انفرتر، ميديا بارد ساخن عادي، ميديا بارد ساخن انفرتر، شارب بارد عادي، شارب بارد انفرتر، شارب بارد ساخن عادي، شارب بارد ساخن انفرتر، تورنيدو بارد عادي، ال جي بارد عادي، فريش بارد عادي، هاير بارد عادي، جري بارد عادي)",
...
1. افحص أعلى الورقة: هل هي ورقة مطبوعة بعنوان "إذن استلام / صرف تكييف"؟
   - تحذير هام: الورقة مطبوعة بكلا الكلمتين (استلام وصرف) بجوار بعضهما، وكذلك كلمة "تم صرف أمين المخزن" مطبوعة كفورمة ثابتة في الأسفل! لا تنخدع بالكلام المطبوع أبداً، بل انظر إلى علامة القلم اليدوي:
     * إذا وُضعت علامة صح (✓) أو إشارة قلم عند مربع "استلام" أو كُتب في السطور "استلمت أنا" -> doc_type: "إذن استلام وتوريد", doc_marker: "__intake_receipt__"
     * فقط إذا وُضعت علامة الصح صراحة بجوار "صرف" -> doc_type: "إذن صرف مبيعات", doc_marker: "__delivery_note__"
